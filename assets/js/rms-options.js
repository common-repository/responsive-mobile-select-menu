	...
	$('.spark-admin-op input[type="checkbox"], #wpmega-demo .spark-admin-op input[type="radio"]')
		.each(function(k, el){
			...
			var $toggle = $('<label class="spark-toggle-onoff '+tog+'" for="'+$(el).attr('id')+
								'"><span class="spark-toggle-inner"><span class="spark-toggle-on"><i class="icon-checkmark"></i></span><span class="spark-toggle-mid"></span><span class="spark-toggle-off"><i class="icon-cross"></i></span></span></label>');
