...
Contributors: Jyria, sevenspark
Donate link: https://www.saskialund.de/donate/
Tags: responsive, menu, select, drop down, mobile menu
...
It has been made translation-ready, PHP 8 ready and its code has been rewritten and restructured to work with WordPress versions greater than 5.x.x
...
1. Navigate to Appearance > Responsive Menu to configure your new mobile select menu
...
1. Responsive mobile select menu on the iPhone/iPod Touch
